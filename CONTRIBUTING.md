...
Thank you for your interest in contributing to the InfluxDB data source for Grafana! We welcome contributions from the community.

Feel free to [browse open issues](https://github.com/grafana/grafana-influxdb-datasource/issues) or open a new one. For more general guidance, see [Grafana's Contributing Guide](https://github.com/grafana/grafana/blob/main/CONTRIBUTING.md).
...
`npm run server` starts a local InfluxDB instance and a Grafana instance with the plugin pre-provisioned:
